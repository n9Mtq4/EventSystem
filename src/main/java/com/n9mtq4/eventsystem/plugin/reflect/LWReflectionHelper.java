...
/**
 * THIS IS MEANT FOR INTERNAL EVENTSYSTEM USAGE ONLY.
 * USE THIS LIBRARY IF YOU WISH TO USE THIS LIBRARY
 * FOR MANAGING REFLECTION
 * https://github.com/n9Mtq4/ReflectionHelper
 * 
 * Note: Use static import for best results.
 * Class to simplify reflection calls.
 */
@SuppressWarnings("unused")
@Deprecated
public final class LWReflectionHelper {
...
//		return getObjectClass(clazz) != null;
	...
	/**
	 * Like {@link LWReflectionHelper#getPrimitiveClass(Class)}, but
	...
	/**
	 * Like {@link LWReflectionHelper#getObjectClass(Class)}, but
